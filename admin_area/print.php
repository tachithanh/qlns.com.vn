...
<div class="inn">
<button class="innn"><a style="float:right" class="bt bt-success" onclick="window.print()">In</a></button>
</div>
        ...
        <table border="0" width="100%" cellspacing="0">
            <tbody>
                ...
                <td align="center">
                    ...
                    <tr>
                    <td align="center">
                    <p><b style="font-size: 2em;">Hoá Đơn</b><br>
                     Số hoá đơn:<i><b>
                    <?php
