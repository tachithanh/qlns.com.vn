...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 02, 2021 lúc 05:17 PM
...
INSERT INTO `bonus` (`id_bonus`, `bonus_name`, `bonus_method`) VALUES
(2, 'Thành tích tốt', 'Tiền mặt'),
(3, 'Khuyến khích', 'Tiền thưởng');
...
CREATE TABLE `customers` (
  ...
  `customer_phongban` text NOT NULL,
  `customer_chucvu` text NOT NULL,
  `customer_contact` varchar(255) NOT NULL,
  `customer_address` text NOT NULL,
  `customer_image` text NOT NULL,
  `customer_ip` varchar(100) NOT NULL,
  `customer_chuyenmon` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `customers` (`customer_id`, `customer_name`, `customer_email`, `customer_pass`, `customer_phongban`, `customer_chucvu`, `customer_contact`, `customer_address`, `customer_image`, `customer_ip`, `customer_chuyenmon`) VALUES
(4, 'Phương Mỹ Chi', 'mychi@gmail.com', '12345', 'Chăm sóc khách hàng', 'Nhân viên', '082 333 333', 'Sân bay Tân Sơn Nhất', '48151750527_16e041bc20_b.jpg', '::1', 'Lập trình'),
(11, 'Chris Evans', 'chrisevans@gmail.com', '34567', 'Chăm sóc khách hàng', 'Thư ký', '1234-5678-1234', 'Sân bay Nội Bài', 'q6D9oh7.jpg', '::1', 'Giao tiếp khách hàng');
...
INSERT INTO `department` (`depart_id`, `depart_name`, `depart_note`) VALUES
(2, 'Phòng Sale', 'Phụ trách việc quản bá sản phẩm'),
(3, 'Chăm sóc bạn Thanh', 'Chăm sóc riêng cho bạn Thanh tại văn phòng'),
(4, 'Chăm sóc bạn Minh', 'Đánh CM bạn Minh'),
(5, 'Chăm sóc bạn Tiên', 'Tiên khùng ăn c heo');
...
INSERT INTO `discipline` (`discipline_id`, `discipline_name`, `discipline_note`) VALUES
(1, 'Đi trễ giờ làm', 'Đi trễ quá giờ làm so với quy định'),
(3, 'Nghỉ làm', 'Nghỉ làm quá nhiều buổi');
...
--
-- Đang đổ dữ liệu cho bảng `expert`
--

INSERT INTO `expert` (`expert_id`, `expert_name`, `expert_note`) VALUES
(1, 'Lập trình viên', 'Chuyên về lập trình cho công ty'),
(3, 'Động viên', 'Thúc đẩy tinh thần cho mọi người');
...
INSERT INTO `level` (`id_level`, `level_name`, `level_note`) VALUES
(2, 'Trình độ Cao Đẳng', 'Trình độ cao đẳng thấp hơn Đại học'),
(3, 'Trình độ Đại học', 'Đại học chính quy');
...
INSERT INTO `position` (`id_position`, `position_name`, `coefficient`) VALUES
(1, 'Trưởng phòng', 1.5);
...
CREATE TABLE `salary` (
  ...
  `salary_describe` varchar(255) NOT NULL,
...
INSERT INTO `salary` (`id_salary`, `salary_describe`, `total_salary`) VALUES
(1, 'Mức lương 1', '50000'),
(2, 'Mức lương 2', '40000');
...
--
ALTER TABLE `bonus`
  MODIFY `id_bonus` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `department`
  MODIFY `depart_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `discipline`
--
ALTER TABLE `discipline`
  MODIFY `discipline_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT cho bảng `expert`
--
ALTER TABLE `expert`
  MODIFY `expert_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `salary`
  MODIFY `id_salary` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
