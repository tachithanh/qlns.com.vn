...
function templateQuotesItem() {
    ...
    const quotes = [{
            name: "John doe",
            text: "Biết nói gì đây, Thiết kế của Lalla thật mong manh thuần khiết. Chất tơ xốp Hàn sang xịn bên ngoài và đầm lụa lót bên trong càng tôn nét dịu dàng ngọt ngào của người mặc.",
        },
        {
            name: "Maria doe",
            text: "Ngọt ngào, sang chảnh và tôn vóc dáng tối đa với mẫu, Chất liệu cao cấp và form dáng đơn giản nhưng tính ứng dụng cao mang lại cho người mặc sự tao nhã.",
        },
        {
            name: "Midu",
            text: "Quyến rũ một cách nhẹ nhàng và tinh tế với mẫu đầm của Lalla. Thiết kế siêu tôn dáng, chất liệu mềm mại lên form người vô cùng thoải mái. Tay áo có thể kéo lên hoặc mặc kiểu trễ vai. ",
        }
    ];
