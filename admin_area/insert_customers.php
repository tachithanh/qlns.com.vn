...
<?php
    if(isset($_POST['submit'])){
        ...
        $insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_phongban,customer_chucvu,customer_contact,customer_address,customer_image,customer_ip,customer_chuyenmon) values ( '$c_name','$c_email','$c_pass','$c_phongban','$c_chucvu','$c_lienhe','$c_diachi','$c_image','$c_ip','$c_chuyenmon')";
