        ...
        <div class="row"><!--3-->
            <div class="col-sm-6 col-md-3"><!--4-->
                ...
                <ul><!--6-->
                    ...
                    <?php
                        if(!isset($_SESSION['customer_email'])){
                            echo "<a href='customer_register.php'> Đăng kí </a>";
            ...
            <div class="col-sm-6 col-sm-3">
                ...
                <form action="https://google.com" method="post" target="popupwindow" onsubmit="window.open('https:/youtube.com'scrollbars=yes,width=550,height=520');return true" method="post"><!--12-->
